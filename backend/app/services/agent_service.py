...
from app.schemas.agent import Itinerary, PlanRequest, PlanResponse
...
class AgentService:
    ...
    async def create_travel_plan(
        self, request: PlanRequest, user: User
    ) -> PlanResponse:
        """Create a travel plan using AI agent"""
        # TODO: Implement AI agent travel planning
        pass

    async def stream_agent_response(self, query: str, user: User):
        """Stream AI agent responses"""
        # TODO: Implement streaming agent responses
        pass

    def _create_agent_run(
        self, user: User, query: str, session_id: Optional[str] = None
    ) -> AgentRun:
    ...
    def _update_agent_run(
        self, agent_run: AgentRun, response: str, status: str
    ) -> AgentRun:
